      ...
      <form onSubmit={handleSubmit} className="p-5 space-y-4">
        ...
        <div className="space-y-1">
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-neutral-600 bg-white dark:bg-neutral-800 text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-neutral-400 resize-none"
          />
        </div>
        ...
        <div className="space-y-1">
          ...
          <select
            ...
            disabled={!dueDate}
            className="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-neutral-600 bg-white dark:bg-neutral-800 text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-neutral-400 disabled:opacity-50"
          >

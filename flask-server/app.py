...
def _run_category_admin(namespace, operation):
    ...
    leaves the transaction empty; a raised error rolls it back via get_cursor().
    """
    try:
        with get_cursor() as cursor:
...
@app.route("/category/usage", methods=["GET"])
@jwt_required()
...
@app.route("/category/<int:category_id>/merge", methods=["POST"])
@jwt_required()
...
@app.route("/finance/category/usage", methods=["GET"])
@jwt_required()
...
@app.route("/finance/category/<int:category_id>", methods=["PUT"])
@jwt_required()
...
@app.route("/finance/category/<int:category_id>", methods=["DELETE"])
@jwt_required()
...
@app.route("/finance/category/<int:category_id>/merge", methods=["POST"])
@jwt_required()
...
@app.route("/todo/category/usage", methods=["GET"])
@jwt_required()
...
@app.route("/todo/category/<int:category_id>", methods=["PUT"])
@jwt_required()
...
@app.route("/todo/category/<int:category_id>", methods=["DELETE"])
@jwt_required()
...
@app.route("/todo/category/<int:category_id>/merge", methods=["POST"])
@jwt_required()
